            ...
            <View className="flex justify-between mx-4">
              <View>
                ...
                <View className="space-y-2 mx-2">
                  <Text className={`${colors.heading} text-lg font-bolt`}>For what?</Text>
                  <TextInput value={title} onChangeText={(value) => setTitle(value)} className="p-4 bg-green-300 rounded-full mb-3" />
                  <Text className={`${colors.heading} text-lg font-bolt`}>How much?</Text>
                  <TextInput value={amount} onChangeText={(value) => setAmount(value)} className="p-4 bg-green-300 rounded-full mb-3" />
                </View>
                <View className="mx-2 space-x-2">
                  ...
                  <View className="flex-row flex-wrap items-center">
                    {categories.map((item) => {
                      ...
                      if (item.value == category) bgColor = "bg-white";
                      return (
              ...
              <View>
                {loading ? (
                  ...
                  <TouchableOpacity onPress={handleAddExpense} className="my-6 rounded-full p-3 mx-2 bg-green-300">
